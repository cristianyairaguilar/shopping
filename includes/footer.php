...
<h3>Trackers for bikes</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Nuestros productos de servicio de GPS y rastreo garantiza el seguimiento en tiempo real con calidad y eficiencia.</p>
...
<div class="contact-timing">
	<div class="module-heading">
		<h4 class="module-title">horarios</h4>
	</div><!-- /.module-heading -->
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(+52) 6462412315<br>(+52) 6461201503</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">isaacgta12@gmail.com</a></span>
                </div>
            </li>
