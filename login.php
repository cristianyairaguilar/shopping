...
<html lang="en">
	<head>
	    ...
	    <title>Trackers for Bikes</title>
...
<div class="col-md-6 col-sm-6 sign-in">
	...
	<p class="">Bienvenido a tu cuenta.</p>
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<p class="text title-tag-line">Crear tu propia cuenta para compras.</p>
...
<div class="form-group">
	    	<label class="info-title" for="confirmpassword">Confirmar cntraseña. <span>*</span></label>
